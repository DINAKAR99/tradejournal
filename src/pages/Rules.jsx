      ...
      <div className="d-md-flex   container-fluid       ">
        ...
        >
          <pre className="text-wrap  ">
            1.Check h1 , h30, h4 before deciding long or short only go if trend
            allows else rekt <br /> <b>exception:</b> at 200 ema can long above
            or short below <br />
            <br />
            2.After a long draw down dont short rather look for longs it doesnt
            work shorting
            <br />
            ...
            <br />
            5.Only trade if emas near or confluenced with support or resistance
            <br />
            <br />
            6.If got more than 1.5 % in a day try to save it dont give to market
            simply
            <br />
            <br />
